...
export class PupilComponent implements OnInit {
  features = [
    ...
    {
      title: 'Удобно',
      text: 'Все занятия будут проходить в образовательном центре <a href="http://smart-um.ru" target="_blank">Смартум</a>.',
      img: 'icons-03'
    },
    // {
    //   title: 'Современно',
  ...
  leaders = [
    ...
    },
    {
      ...
      "prouds": [
        ...
        "Среди учеников — финалисты финала Всероссийской олимпиады по физике, олимпиада имени Дж.К. Максвелла"
      ]
    },
    {
      "name": "Иван Максимович Казёнов",
      "status": "Ведущий методист по информатике, магистр МФТИ по направлению прикладные математика и физика",
      "prouds": [
        "Стаж преподавания — 6 лет",
        "Средний балл учеников по профильному ЕГЭ по физике – 80"
      ]
    }
  ]
